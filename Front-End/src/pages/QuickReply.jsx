...
const QuickReply = () => {
  ...
  return (
    <div className="md:w-[90%] w-[95%] mx-auto mt-8">
      ...
      <p className="mb-6">
        Generate instant replies for messages, emails, or chats.
      </p>

      <div className="grid md:grid-cols-2 gap-10">
        {/* Input */}
        <div>
          <h2 className="font-medium mb-2">Message to Reply</h2>
          <textarea
            className="w-full h-[250px] border-2 rounded-md p-3 bg-gray-100 resize-none"
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            <h2 className="font-medium">Generated Reply</h2>
          ...
          <textarea
            readOnly
            value={outputText}
            className="w-full h-[300px] border-2 rounded-md p-3 bg-gray-100 cursor-not-allowed"
